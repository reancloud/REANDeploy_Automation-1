...
@RegressionTest
Feature: Test on AWS ECS SERVIVE Definition 
...
@P1 
Scenario: To check the functionality of re deploy button for Ecs Service	
	...
	And i enter desired count for Ecs Service
	And i enter task definition for Ecs Service 
	When User click on save button on dash board
...
Scenario: To check the functionality of save button if user edits Ecs Task def resource name 	
	...
	When User click the name text box to edit resource name "test-EcsService"
...
Scenario:To check the functionality of delete  button if user wants to delete resource	
	...
	Then i enter resource name of Ecs Service
	When User click on create button on resource pop up
	And I  delete the Ecs Service resource by clicking the cross button on resource
	And User refresh the page
	Then i delete the created environment for Ecs Service
